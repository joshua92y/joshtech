...
<Feedback
  ...
  description={
    <>
      Make sure you have updated the <InlineCode>content.js</InlineCode> file with your own
      information and the <InlineCode>baseURL</InlineCode> variable in the{" "}
      <InlineCode>config.js</InlineCode> file.
    </>
  }
/>
